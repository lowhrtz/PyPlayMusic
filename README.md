...
--------------------------
The default backend uses GStreamer 1.0 and should be available on<br />
most current Gnome/GTK systems. There is a backup backend that uses<br />
VLC. VLC needs to be installed to use it. Also, python-vlc needs to<br />
